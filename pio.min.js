 ...
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
var Paul_Pio=function(prop){var current={idol:0,menu:document.querySelector(".pio-container .pio-action"),canvas:document.getElementById("pio"),body:document.getElementsByClassName("pio-container")[0],root:document.location.protocol+"//"+document.location.hostname+"/"},modules={idol:function(){return current.idol<prop.model.length-1?current.idol++:current.idol=0,current.idol},create:function(e,n){var o=document.createElement(e);return n.class&&(o.className=n.class),o},rand:function(e){return e[Math.floor(Math.random()*e.length+1)-1]},render:function(e){e.constructor===Array?dialog.innerText=modules.rand(e):e.constructor===String?dialog.innerText=e:dialog.innerText="Có lỗi xảy ra X_X",dialog.classList.add("active"),clearTimeout(this.t),this.t=setTimeout(function(){dialog.classList.remove("active")},3e3)},destroy:function(){current.body.parentNode.removeChild(current.body),document.cookie="posterGirl=false;path=/"}},elements={home:modules.create("span",{class:"pio-home"}),skin:modules.create("span",{class:"pio-skin"}),info:modules.create("span",{class:"pio-info"}),night:modules.create("span",{class:"pio-night"}),close:modules.create("span",{class:"pio-close"})},dialog=modules.create("div",{class:"pio-dialog"});current.body.appendChild(dialog);var action={welcome:function(){if(""!==document.referrer&&-1===document.referrer.indexOf(current.root)){var e=document.createElement("a");e.href=document.referrer,prop.content.referer?modules.render(prop.content.referer.replace(/%t/,"“"+e.hostname+"”")):modules.render("欢迎来自 “"+e.hostname+"” 的朋友！")}else if(prop.tips){var n,o=(new Date).getHours();n=o>22||o<=5?"Đô Đốc Đẩu đi ngủ mất rồi (｡T ω T｡)":o>5&&o<=8?"Chào buổi sáng Đô Đốc！":o>8&&o<=11?"Nhớ vận động hàng ngày nhé Đô Đốc, đừng ngồi một chỗ！(｀・ω・´)":o>11&&o<=14?"Đô Đốc đã làm việc vất vả suốt sáng rồi, ĐI ĂN TRƯA THÔI. ĐÔ ĐỐC LÀM CHẬM QUÁ ĐẤY！( ﾉｼ・ヮ・)ﾉｼ三( ﾉｼ・ヮ・)ﾉｼ":o>14&&o<=17?"Chiều rồi! Anh đã hoàn thành mục tiêu hôm nay chưa?":o>17&&o<=19?"Ánh hoàng hôn buổi chiều thật đẹp :) Cảm ơn anh đã luôn làm việc vất vả vì em :))":o>19&&o<=21?"Tối nay anh muốn làm gì đây (｀・ω・´)":o>21&&o<=23?"Muộn rồi, đi ngủ thôi Đô Đốc!":"Ou ou ou",modules.render(n)}else modules.render(prop.content.welcome||"Chào mừng đến blog của Đô Đốc Đẩu")},touch:function(){current.canvas.onclick=function(){modules.render(prop.content.touch||["Sao vậy?","Chạm vào nữa là tôi gọi cảnh sát đó tên lolicon","HENTAI!","Cút!"])}},buttons:function(){elements.home.onclick=function(){location.href=current.root},elements.home.onmouseover=function(){modules.render(prop.content.home||"Nhấn vào đây để về trang chủ")},current.menu.appendChild(elements.home),elements.skin.onclick=function(){loadlive2d("pio",prop.model[modules.idol()]),prop.content.skin&&prop.content.skin[1]?modules.render(prop.content.skin[1]):modules.render("Shimakaze đi cosplay nhân vật khác đây!")},elements.skin.onmouseover=function(){prop.content.skin&&prop.content.skin[0]?modules.render(prop.content.skin[0]):modules.render("Muốn em đi cosplay ai khác à?")},prop.model.length>1&&current.menu.appendChild(elements.skin),elements.info.onclick=function(){window.open(prop.content.link||"https://paugram.com/coding/add-poster-girl-with-plugin.html")},elements.info.onmouseover=function(){modules.render("Muốn biết thêm về em à?")},current.menu.appendChild(elements.info),prop.night&&(elements.night.onclick=function(){eval(prop.night)},elements.night.onmouseover=function(){modules.render("Đánh đêm")},current.menu.appendChild(elements.night)),elements.close.onclick=function(){modules.destroy()},elements.close.onmouseover=function(){modules.render(prop.content.close||"Hẹn gặp lại!!")},current.menu.appendChild(elements.close)},custom:function(){prop.content.custom.forEach(function(e){e.type||(e.type="default");var n=document.querySelectorAll(e.selector);if(n.length)for(var o=0;o<n.length;o++)"read"===e.type?n[o].onmouseover=function(){modules.render("Muốn %t à？".replace(/%t/,"“"+this.innerText+"”"))}:"link"===e.type?n[o].onmouseover=function(){modules.render("Muốn biết %t à？".replace(/%t/,"“"+this.innerText+"”"))}:e.text&&(n[o].onmouseover=function(){modules.render(e.text)})})}},begin={static:function(){current.body.classList.add("static")},fixed:function(){action.touch(),action.buttons()},draggable:function(){action.touch(),action.buttons();var e=current.body;e.onmousedown=function(){var n={x:event.clientX-this.offsetLeft,y:event.clientY-this.offsetTop};function o(o){e.classList.add("active"),e.classList.remove("right"),e.style.left=event.clientX-n.x+"px",e.style.top=event.clientY-n.y+"px"}document.addEventListener("mousemove",o),document.addEventListener("mouseup",function(){e.classList.remove("active"),document.removeEventListener("mousemove",o)})}}};this.init=function(){if(!0===prop.hidden&&window.innerWidth<400)current.body.classList.add("hidden");else{switch(action.welcome(),prop.mode){case"static":begin.static();break;case"fixed":begin.fixed();break;case"draggable":begin.draggable()}prop.content.custom&&action.custom(),loadlive2d("pio",prop.model[0])}},this.init()};window.console&&window.console.log&&console.log("%c Pio %c https://paugram.com ","color: #fff; margin: 1em 0; padding: 5px 0; background: #673ab7;","margin: 1em 0; padding: 5px 0; background: #efefef;");
